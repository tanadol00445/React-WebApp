    ...
    <>
        <form onSubmit={submitForm}>
            ...
            <div className='flex gap-x-2 bg-white rounded-md shadow-sm p-2 pl-3 mt-2'>
                <input id="title" type="text" className="focus:outline-none w-full" maxLength="30" placeholder='Type Somthing here...' autoFocus required value={title} onChange={(e) => setTitle(e.target.value)}></input>
